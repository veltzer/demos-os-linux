...
Notice that the object `B` which seems to need a constructor of it's own does not seem to get one. This is probably due to the fact that it has no parents and so no-one to call...
