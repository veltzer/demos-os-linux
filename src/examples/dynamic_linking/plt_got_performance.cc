...
int main() {
	...
	__typeof__(stdin)* p_dlsym_stdin=(__typeof__(stdin)*)dlsym(RTLD_NEXT, "stdin");
	printf("p_direct_atoi is %p\n", reinterpret_cast<void*>(p_direct_atoi));
	printf("p_dlsym_atoi is %p\n", reinterpret_cast<void*>(p_dlsym_atoi));
	printf("p_direct_printf is %p\n", reinterpret_cast<void*>(p_direct_printf));
	printf("p_dlsym_printf is %p\n", reinterpret_cast<void*>(p_dlsym_printf));
	printf("p_direct_getpid is %p\n", reinterpret_cast<void*>(p_direct_getpid));
	printf("p_dlsym_getpid is %p\n", reinterpret_cast<void*>(p_dlsym_getpid));
	printf("p_direct_stdin is %p\n", static_cast<void*>(p_direct_stdin));
	printf("p_dlsym_stdin is %p\n", static_cast<void*>(p_dlsym_stdin));
